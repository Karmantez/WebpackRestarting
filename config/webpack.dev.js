...
module.exports = {
  ...
  devServer: {
    ...
    devMiddleware: {
      index: 'index.html',
      /**
       * file 들을 memory에 올림으로써 disk에 저장하지 않는다.
       * 이 경우 dist folder는 비어있게 된다.
       */
      writeToDisk: true,
    },
    hot: true,
  ...
  module: {
    rules: [
       ...
       */
      {
        ...
        use: [
          /**
           * development 에선 굳이 css 파일을
           * extract 할 필요가 없기 때문에 style-loader를 set 한다.
           */
          'style-loader',
          {
            loader: 'css-loader',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      title: 'Webpack5 - Boiler plate (development)s',
